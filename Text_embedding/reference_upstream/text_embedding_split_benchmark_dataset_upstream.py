...
dataset produced by text_embedding_build_benchmark_dataset_upstream.py.
...
Usage:
    python text_embedding_split_benchmark_dataset_upstream.py \\
...
def parse_args():
    ...
    p.add_argument("--benchmark_dir",  required=True,
                   help="Directory containing benchmark_*.csv files "
                        "(output of text_embedding_build_benchmark_dataset_upstream.py).")
